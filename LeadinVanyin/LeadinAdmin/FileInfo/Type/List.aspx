<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="LeadinWeb.Vanyin.FileInfo.Type.List" %>
            ...
            <div id="pagemain">
                ...
                <div class="mapMenu">
                    <ul>
                        ...
                        <li>></li>
                        <li><a href="../Product/List.aspx">图片管理</a></li>
                        <li>></li>
                        <li>类别列表</li>
                    </ul>
                </div>
