...
namespace LeadinWeb.Vanyin.Store.StoreType
{
    public partial class Edit : Leadin.Web.UI.ManagePage
    {
        ...
        {
            Leadin.Model.StoreType model = blltype.GetModel(typeid);
        ...
        protected void btnOk_Click(object sender, EventArgs e)
        {
            ...
            if (IsEdit)
            {
                ...
                {
                    JsMessage("success", "门店类别添加成功！", 1000, "List.aspx");
                }
                else
                {
                    JsMessage("error", "门店类别添加失败，请检查您的输入！", 1000, "back");
                }
            ...
            else
            {
                ...
                {
                    JsMessage("success", "门店类别编辑成功！", 1000, "List.aspx?page=" + Request.Params["page"]);
                }
                else
                {
                    JsMessage("error", "门店类别编辑失败，请检查您的输入！", 1000, "back");
                }
