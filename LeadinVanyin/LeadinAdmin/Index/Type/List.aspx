<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="LeadinWeb.Vanyin.Index.Type.List" %>
                        ...
                        <asp:Repeater runat="server" ID="repList" OnItemCommand="repList_ItemCommand">
                            <ItemTemplate>
                                <ul class="listli">
                                    ...
                                    <li style="width: 100px;"><%# GetParentName(Eval("ParentId").ToString()) %> </li>
