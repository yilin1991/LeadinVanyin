...
namespace Leadin.DAL
{
	...
	public partial class MemberType
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "tb_MemberType"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from tb_MemberType");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Leadin.Model.MemberType model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tb_MemberType(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Leadin.Model.MemberType model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tb_MemberType set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tb_MemberType ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Leadin.Model.MemberType GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,Title,SubTitle,SortNum,ParentId,StateInfo,DetailRemark,Remark,AddTime from tb_MemberType ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Leadin.Model.MemberType DataRowToModel(DataRow row)
		{
			Leadin.Model.MemberType model=new Leadin.Model.MemberType();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM tb_MemberType ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tb_MemberType T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tb_MemberType";
