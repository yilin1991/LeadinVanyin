<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="LeadinWeb.Vanyin.Member.Member.List" %>
                ...
                <div class="contentBox">
                    ...
                    <ul class="search row">
                        ...
                        <li>
                            <asp:DropDownList runat="server" ID="ddltype">
                                <asp:ListItem Value="0">会员类别</asp:ListItem>
                            </asp:DropDownList>
                        ...
                        <li>
                            <asp:DropDownList runat="server" ID="ddlKey">
                                ...
                                <asp:ListItem Value="2">帐号</asp:ListItem>
                     ...
                     <ul class="search row">
                        <li class="small">请选择文件：</li>
                        <li>
                            <asp:FileUpload runat="server" ID="fileExecl" />
                        </li>
                        <li>
                            <asp:Button runat="server" ID="btnDaoru" Text="导入" OnClick="btnDaoru_Click" />
                        </li>
                    ...
                    <div class="listtable">
                        <ul class="tbtitle">
                            ...
                            <li style="width: 100px;">帐号</li>
                            <li style="width: 100px;">手机号</li>
                            <li style="width: 100px;">邮箱</li>
                            <li style="width: 100px;">会员类别</li>
                            <li style="width: 100px;">会员状态</li>
                            <li style="width: 100px;">注册时间</li>
                            <li style="width: 100px;">姓名</li>
                            <li style="width: 100px;">别名</li>
                            <li style="width: 100px;">性别</li>
                            <li style="width: 100px;">年龄</li>
                            <li style="width: 200px;">公司名称</li>
                            <li style="width: 200px;">公司地址</li>
                            <li style="width: 100px;">职位</li>
                            <li style="width: 200px;">详细地址</li>
                        </ul>
                            ...
                            <ItemTemplate>
                                <ul class="listli">
                                    ...
                                    <li class="operli" style="width: 100px;">
                                        ...
                                        <a class="operliready" href="#" title="收货地址"><i class="icon-file-alt"></i></a>
                                    </li>
                                    <li style="width: 100px;">
                                        <asp:HiddenField runat="server" ID="hidId" Value='<%#Eval("Id") %>' />
                                        <asp:Label runat="server" ID="lbid" Text='<%# Eval("Num") %>'></asp:Label></li>
                                    <li style="width: 100px;"><%#string.IsNullOrEmpty(Eval("Account").ToString())?"无账号":Eval("Account").ToString() %> </li>
                                    <li style="width: 100px;"><%#string.IsNullOrEmpty(Eval("Phone").ToString())?"无手机号":Eval("Phone").ToString() %> </li>
                                    <li style="width: 100px;"><%#string.IsNullOrEmpty(Eval("Email").ToString())?"无邮箱":Eval("Email").ToString() %> </li>
                                    <li style="width: 100px;"><%# new Leadin.BLL.MemberType().GetModel(int.Parse(Eval("TypeId").ToString())).Title %> </li>
                                    ...
                                    <li style="width: 100px;"><%#string.IsNullOrEmpty(Eval("NameInfo").ToString())?"无姓名":Eval("NameInfo").ToString() %> </li>
                                    <li style="width: 100px;"><%#string.IsNullOrEmpty(Eval("SubName").ToString())?"无别名":Eval("SubName").ToString() %> </li>
                                    <li style="width: 100px;"><%#string.Equals(Eval("Sex").ToString(),"0")?"女":(string.Equals(Eval("Sex").ToString(),"1")?"男":"保密") %> </li>
                                    <li style="width: 100px;"><%#string.IsNullOrEmpty(Eval("Age").ToString())?"无年龄":Eval("Age").ToString() %> </li>
                                    <li style="width: 200px;"><a class="suba" title="<%#Eval("CompanyAddress") %>"><%# string.IsNullOrEmpty(Eval("CompanyAddress").ToString())?"无公司名称":Eval("CompanyName").ToString() %></a> </li>
                                    <li style="width: 200px;"><a class="suba" title="<%#Eval("CompanyAddress") %>"><%#string.IsNullOrEmpty( Eval("CompanyAddress").ToString())?"无公司地址":Eval("CompanyAddress").ToString() %></a> </li>
                                    <li style="width: 100px;"><%# string.IsNullOrEmpty(Eval("Position").ToString())?"无职位":Eval("Position") %> </li>
                                    <li style="width: 200px;"><a class="suba" title="<%#Eval("AddressInfo") %>"><%#string.IsNullOrEmpty(Eval("AddressInfo").ToString())?"无地址":Eval("AddressInfo") %></a> </li>
