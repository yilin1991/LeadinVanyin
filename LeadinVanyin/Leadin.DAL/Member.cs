...
namespace Leadin.DAL
{
	...
	public partial class Member
	{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,Num,Account,Pwd,Phone,Email,TypeId,StateInfo,HeaderImg,OpenId,AddTime ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,Num,Account,Pwd,Phone,Email,TypeId,StateInfo,HeaderImg,OpenId,AddTime ");
			strSql.Append(" FROM tb_Member ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
