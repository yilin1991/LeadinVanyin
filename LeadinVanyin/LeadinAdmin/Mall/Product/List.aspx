<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="LeadinWeb.Vanyin.Mall.Product.List" %>
                ...
                <div class="contentBox">
                    ...
                    <div class="listtable">
                        <ul class="tbtitle">
                            ...
                            <li style="width: 100px;">商品排序</li>
                            <li style="width: 100px;">商品状态</li>
                            <li style="width: 100px;">商品属性</li>
                            <li style="width: 100px;">所需积分</li>
                            <li style="width: 100px;">实际价格</li>
                            <li style="width: 100px;">库存数量</li>
                        ...
                        <asp:Repeater runat="server" ID="repList" OnItemCommand="repList_ItemCommand">
                            <ItemTemplate>
                                <ul class="listli">
                                    ...
                                    <li style="width: 200px;"><a class="suba" title="<%#Eval("NameInfo") %>"><%#Eval("NameInfo") %></a></li>
                                    <li style="width: 100px;"><%#GetTypeName(int.Parse(Eval("MallType").ToString())) %></li>
                                    ...
                                    <li style="width: 100px;"><%#Eval("Price") %>元</li>
                                    <li style="width: 100px;"><%#Eval("Stock") %></li>
