<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="LeadinWeb.Vanyin.Store.StoreCity.List" %>
                            ...
                            <ItemTemplate>
                                <ul class="listli">
                                    ...
                                    <li class="operli" style="width: 100px;">
                                       ...
                                       <a class="operlidel" href="SubList.aspx?id=<%#Eval("Id") %>" title="子城市"><i class="icon-bookmark"></i></a>                                                                     <a class="operliadd" href="Edit.aspx?typeid=<%#Eval("Id") %>" title="添加子城市"><i class="icon-plus"></i></a>
                                    </li>
