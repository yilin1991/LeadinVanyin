<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="LeadinWeb.Login" %>
    ...
    <form runat="server" id="myForm">
        <div id="loginHeader">
            <div class="loginHeaderLeft">
                <ul>
                    <li>
                        <img src="/Vanyin/img/temp/login_small.png" /></li>
        ...
        <div id="loginContent">
            <div class="loginContentLogo">
                <img src="/Vanyin/img/temp/loginlogo.png" />
            </div>
            <div class="loginContentForm">
                <div class="loginContentFormLeft">
                    <img src="/Vanyin/img/temp/Logo1.jpg" />
                </div>
                <div class="loginContentFormRight">
                    ...
                    <div class="loginContentForm_Input">
                        <div class="loginContentForm_InputImg">
                            <img src="/Vanyin/img/user_ico.png" />
                        </div>
                    ...
                    <div class="loginContentForm_Input">
                        <div class="loginContentForm_InputImg">
                            <img src="/Vanyin/img/user_pass.png" />
                        </div>
                        <div class="loginContentForm_InputText">
