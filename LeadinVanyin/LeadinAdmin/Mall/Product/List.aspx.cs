...
namespace LeadinWeb.Vanyin.Mall.Product
{
    public partial class List : System.Web.UI.Page
    {
        ...
        void BindRepList()
        {
            ...
            repList.DataSource = bll.GetListByPage( strWhere.ToString(), "SortNum desc, Num desc,Id desc",pagesize* page,pagesize*page+pagesize);
            repList.DataBind();
        ...
        protected void repList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "lbtnState")//修改状态
            {
                ...
                Leadin.Model.Mall model = bll.GetModel(int.Parse(hidid.Value));
