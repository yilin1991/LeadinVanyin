...
namespace Leadin.DAL
{
	...
	public partial class Designer
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "tb_Designer"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from tb_Designer");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Leadin.Model.Designer model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tb_Designer(");
			strSql.Append("Num,NameInfo,Sex,Birthday,Phone,Email,AddressInfo,TypeId,StateInfo,SortNum,FileUrl,Remark,AddTime)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Leadin.Model.Designer model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tb_Designer set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tb_Designer ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Leadin.Model.Designer GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,Num,NameInfo,Sex,Birthday,Phone,Email,AddressInfo,TypeId,StateInfo,SortNum,FileUrl,Remark,AddTime from tb_Designer ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Leadin.Model.Designer DataRowToModel(DataRow row)
		{
			Leadin.Model.Designer model=new Leadin.Model.Designer();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,Num,NameInfo,Sex,Birthday,Phone,Email,AddressInfo,TypeId,StateInfo,SortNum,FileUrl,Remark,AddTime ");
			strSql.Append(" FROM tb_Designer ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,Num,NameInfo,Sex,Birthday,Phone,Email,AddressInfo,TypeId,StateInfo,SortNum,FileUrl,Remark,AddTime ");
			strSql.Append(" FROM tb_Designer ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tb_Designer T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tb_Designer";
