<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="LeadinWeb.Vanyin.Index.Type.Edit" %>
            ...
            <div id="pagemain">
                ...
                <div class="contentBox">
                    ...
                    <div class="editForm">
                       ...
                       <div class="control-group">
                            <label class="control-label" for="ddlType">所属类别</label>
                            <div class="controls">
                                <asp:DropDownList runat="server" ID="ddlType" DataMember="5"  datatype="*" nullmsg="请选择所属类别！" errormsg="所属类别不能为空！">
                                    <asp:ListItem Value="">请选择所属类别</asp:ListItem>
                                    <asp:ListItem Value="1">模版类别</asp:ListItem>
                                    <asp:ListItem Value="2">案例类别</asp:ListItem>
                                </asp:DropDownList>
                                <span class="help-inline">请选择所属类别！</span>
                            </div>
                        </div>
                        <div class="control-group">
