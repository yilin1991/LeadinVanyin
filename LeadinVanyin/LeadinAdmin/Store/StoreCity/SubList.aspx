<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubList.aspx.cs" Inherits="LeadinWeb.Vanyin.Store.StoreCity.SubList" %>
        ...
        <div id="main">
            ...
            <div id="pagemain">
                ...
                <div class="contentBox">
                    ...
                    <ul class="operation">
                        <li class="operadd"><a href="Edit.aspx?typeid=<%=Request.Params["id"] %>"><i class="icon-plus"></i>添加</a></li>
                    </ul>
                            ...
                            <ItemTemplate>
                                <ul class="listli">
                                    ...
                                    <li class="operli" style="width: 100px;">
                                       <a class="operliedit" href="Edit.aspx?id=<%#Eval("Id") %>&typeid=<%#Request.Params["id"] %>" title="编辑"><i class="icon-edit"></i></a>                                    
                                    </li>
                                    ...
                                    <li style="width: 200px;"><a class="suba" title="<%#Eval("Title") %>"><%#Eval("Title") %></a></li>
                                        <li style="width: 100px;"><%#GetCityName( Eval("ParentId").ToString()) %> </li>
