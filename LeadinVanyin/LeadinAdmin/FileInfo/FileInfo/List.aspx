<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="LeadinWeb.Vanyin.FileInfo.FileInfo.List" %>
                ...
                <div class="contentBox">
                    ...
                    <ul class="search row">
                        ...
                        <li>
                            <asp:DropDownList runat="server" ID="ddltype">
                                <asp:ListItem Value="0">请选择文件类别</asp:ListItem>
                            </asp:DropDownList>
                        </li>
                        <li>
                            <asp:DropDownList runat="server" ID="ddlKey">
                                <asp:ListItem Value="0">请选择搜索类别</asp:ListItem>
                                <asp:ListItem Value="1">文件编号</asp:ListItem>
                                <asp:ListItem Value="2">文件名称</asp:ListItem>
                            </asp:DropDownList>
                        </li>
                        <li>
                    ...
                    <div class="listtable">
                        <ul class="tbtitle">
                            ...
                            <li style="width: 200px;">文件名称</li>
                            <li style="width: 100px;">文件类别</li>
                            <li style="width: 100px;">文件排序</li>
                            <li style="width: 100px;">文件状态</li>
                            <li style="width: 100px;">文件属性</li>
                            <li style="width: 100px;">链接地址</li>
                        ...
                        <asp:Repeater runat="server" ID="repList" OnItemCommand="repList_ItemCommand">
                            <ItemTemplate>
                                <ul class="listli">
                                    ...
                                    <li style="width: 100px;"><%#GetTypeName(int.Parse(Eval("TypeId").ToString())) %></li>
                                    ...
                                    <li style="width: 100px;"><a class="suba" title="<%#Eval("LinkUrl") %>"><%#Eval("LinkUrl") %></a></li>
